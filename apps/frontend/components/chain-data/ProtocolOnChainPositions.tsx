...
<VaultPositions key={crypto.randomUUID()} depositors={depositors as ethereumAddress[]} collateralManagerAddress={collateralManagerAddress} tokenAddr={tokenAddr} vaultManagerAddress={vaultManagerAddress}/>
))}
