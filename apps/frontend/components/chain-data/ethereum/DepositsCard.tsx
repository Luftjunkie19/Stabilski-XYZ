...
function DepositsCard() {;
   ...
   <div className="flex flex-col gap-2 max-w-lg w-full bg-white border-red-500 border-1 shadow-md shadow-black overflow-y-auto overflow-x-hidden p-3 rounded-lg h-64">
