...
<motion.div initial={{scale:0, transitionDuration:'1s', transitionDelay:'0.5s', animationDelay:'0.5s'}} whileInView={{scale:1, transitionDuration:'1s', transitionDelay:'0.5s', animationDelay:'0.5s'}} className="flex flex-col gap-1 w-full">
...
<p className='text-black text-lg text-shadow-sm text-shadow-white'>The Stabilski Polish Stablecoin Lending protocol works in the following way:</p>
 ...
 <motion.div whileInView={{translateX:0, scale:1, transitionDuration:'1s', transitionDelay:'0.5s', animationDuration:'1s', animationDelay:'0.5s' }} initial={{translateX:"-100%", transitionDuration:'1s', animationDuration:'1s', scale:0, transitionDelay:'0.5s', animationDelay:'0.5s' }} className="bg-white border border-black shadow-sm  flex mx-auto flex-col gap-3 shadow-black rounded-lg p-2 max-w-lg w-full">
  <p>
